...
namespace Articy.Articy_Draft_Test_Drive.Templates
{
    ...
    public class DefaultMainCharacterTemplateTemplate : IArticyBaseObject, IPropertyProvider
    {
        ...
        public Articy.Articy_Draft_Test_Drive.Features.DefaultExtendedCharacterFeatureFeature DefaultExtendedCharacterFeature
        {
            get
            {
        ...
        public Articy.Articy_Draft_Test_Drive.Features.DefaultBasicCharacterFeatureFeature DefaultBasicCharacterFeature
        {
            get
            {
        ...
        {
            Articy.Articy_Draft_Test_Drive.Templates.DefaultMainCharacterTemplateTemplate newClone = ((Articy.Articy_Draft_Test_Drive.Templates.DefaultMainCharacterTemplateTemplate)(aClone));
            if ((DefaultExtendedCharacterFeature != null))
            {
                newClone.DefaultExtendedCharacterFeature = ((Articy.Articy_Draft_Test_Drive.Features.DefaultExtendedCharacterFeatureFeature)(DefaultExtendedCharacterFeature.CloneObject(newClone, aFirstClassParent)));
            }
            if ((DefaultBasicCharacterFeature != null))
            {
                newClone.DefaultBasicCharacterFeature = ((Articy.Articy_Draft_Test_Drive.Features.DefaultBasicCharacterFeatureFeature)(DefaultBasicCharacterFeature.CloneObject(newClone, aFirstClassParent)));
            }
        ...
        {
            Articy.Articy_Draft_Test_Drive.Templates.DefaultMainCharacterTemplateTemplate clone = new Articy.Articy_Draft_Test_Drive.Templates.DefaultMainCharacterTemplateTemplate();
